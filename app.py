...
with col_right:
    ...
    with tab_reg:
        ...
        fig_reg.update_layout(
            ...
            height=230,
            xaxis=dict(title=dict(text="% Zero-vehicle HH", font=dict(size=10)),
                       gridcolor=GREY, ticksuffix="%"),
            yaxis=dict(title=dict(text="% ≤1 vehicle HH", font=dict(size=10)),
                       gridcolor=GREY, ticksuffix="%"),
    ...
    with tab_equity:
        ...
        fig_eq.update_layout(
            ...
            margin=dict(l=8, r=8, t=8, b=8),
            height=230,
            yaxis=dict(ticksuffix="%", gridcolor=GREY,
                       title=dict(text="Share of households", font=dict(size=10))),
            xaxis=dict(title=dict(text="Income constraint quartile", font=dict(size=10))),
    ...
    fig_pop.update_layout(
        ...
        margin=dict(l=8, r=8, t=8, b=8),
        height=195,
        xaxis=dict(gridcolor=GREY, title=dict(text="Year", font=dict(size=10))),
        yaxis=dict(gridcolor=GREY, ticksuffix="M",
                   title=dict(text="Population (millions)", font=dict(size=10))),
        legend=dict(font=dict(size=9), x=0.01, y=0.99,
                    bgcolor="rgba(255,255,255,0.8)"),
    )
